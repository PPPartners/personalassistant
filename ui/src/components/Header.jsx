...
function Header({ currentFocus, onStartDay, onEndDay, onShowFocus, onStartPomodoro }) {
  return (
    <header className="glass border-b border-dark-border px-6 py-4 flex items-center justify-between">
      <div>
        <h1 className="text-2xl font-bold text-text-primary">PersonalAssistant</h1>
        <p className="text-sm text-text-tertiary">Task & workflow manager</p>
      </div>
